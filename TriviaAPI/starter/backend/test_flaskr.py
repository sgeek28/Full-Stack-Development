...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.new_question = {
            'question': 'Which is best singer in India?',
            'answer': 'Arijit Singh',
            'difficulty': 2,
            'category': '5'
        }
    ...
    def test_get_paginated_questions_item(self):
    ...
    def test_404_request_exceeding_valid_page(self):
    ...
    def test_delete_questions_item(self):
    ...
    def test_search_questions_item(self):
    ...
    def test_get_questions_by_category_wise(self):
    ...
    def test_400_questions_by_category_fails(self):
